...
@Component({
    ...
    template: `
        <div class="bg-gray-100 border-l-4 border-gray-500 text-gray-800 p-4 rounded-lg shadow-md mb-4">
...
export class CourseDraftComponent implements OnInit {
  ...
  ngOnInit() {
      this.courseService.getDraftCourses().subscribe(
          (response) => {
