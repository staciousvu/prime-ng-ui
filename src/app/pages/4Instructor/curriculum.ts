...
@Component({
    ...
    <div class=" min-h-screen">
            ...
            <div *ngFor="let section of sections; let sectionIndex = index" class="mb-4 p-4 bg-white shadow rounded-lg border border-gray-200">
                ...
                <div class="flex justify-between items-center mb-3">
                    ...
                    <button (click)="startEditSection(sectionIndex)" type="button"
                        class="flex items-center space-x-2 rounded-md border border-purple-600 bg-white hover:bg-purple-50 active:bg-purple-100 text-purple-700 font-semibold text-base px-4 py-2 transition">
                        <i class="pi pi-pencil text-lg"></i>
                        <!-- <span>Edit</span> -->
                    </button>

                    <button (click)="deleteSection(sectionIndex, section.id)" type="button"
                        class="flex items-center space-x-2 rounded-md border border-red-600 bg-white hover:bg-red-50 active:bg-red-100 text-red-700 font-semibold text-base px-4 py-2 transition">
                    ...
                    <input [(ngModel)]="editedSectionTitle" placeholder="Enter section title" 
                          type="text"
                          class="w-full rounded-md border border-gray-300 px-4 py-2 text-base text-gray-700 focus:border-purple-600 focus:ring-1 focus:ring-purple-600 outline-none transition" />
                        ...
                        <button (click)="cancelEditSection()" type="button"
                            class="flex items-center space-x-2 rounded-md border border-gray-600 bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-700 font-semibold text-base px-4 py-2 transition">
                ...
                <div class="p-4 bg-white shadow rounded-lg border border-gray-200">
                    ...
                    <div *ngFor="let lecture of section.lectures; let lectureIndex = index" class="mb-3 bg-white">
                        ...
                        <label
                            class="flex items-center space-x-2 rounded-md border border-purple-600 bg-white hover:bg-purple-50 active:bg-purple-100 text-purple-700 font-semibold text-base px-4 py-2 cursor-pointer transition">
                            ...
                            <!--  -->
                                ...
                                <div *ngIf="lecture.contentUrl && !lecture.isUploading" class="flex justify-center items-center mt-4">
                                    <video [src]="lecture.contentUrl" controls class="w-3/6 md:w-2/4 rounded-lg shadow-lg border"></video>
                                </div>
            ...
            <button (click)="startAddingSection()" type="button"
                class="flex items-center space-x-2 rounded-md border border-purple-600 bg-white hover:bg-purple-50 active:bg-purple-100 px-4 py-2 text-purple-700 font-semibold text-base transition">
